    ...
    <main className="min-h-screen bg-background relative flex flex-col">
      ...
      <header className="w-full flex items-center justify-between p-6 z-10">
        <div className="flex items-center gap-3">
          <Image src="/icon.png" alt="CheckMate" width={32} height={32} className="rounded-md" />
        ...
        <div className="flex-1 w-full max-w-[600px] hidden md:flex flex-col gap-8">
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant text-lg max-w-md">
              Whether you're playing for practice, rating, or real stakes—your next challenge awaits.
            </p>
          </div>
