  ...
  return (
    <div className="bg-surface luxury-glow border border-border rounded-lg p-8 md:p-10 relative overflow-hidden backdrop-blur-sm">
      ...
      <div className="space-y-6 mb-8">
        ...
        <div className="bg-surface-dim p-5 border border-border rounded-lg text-left">
          <h4 className="text-text-primary font-bold mb-1 flex items-center gap-2">
          ...
          <p className="text-text-muted text-sm ml-6">
            We will send your exclusive activation link when your spot opens up.
          </p>
        </div>
      </div>
